...
from sklearn.metrics import classification_report, roc_curve, auc, accuracy_score, confusion_matrix, precision_recall_curve
...
precision, recall, thresholds = precision_recall_curve(y_test, stacked_proba)
plt.figure()
