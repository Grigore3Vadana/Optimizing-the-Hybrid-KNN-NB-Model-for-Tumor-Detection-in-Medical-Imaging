...
from knn_nb import stacked_model
...
subset_true_labels = y_test[subset_indices]
subset_predicted_labels = stacked_model.predict(subset_images)

# Display the Images with Predicted Labels
display_images_with_predictions(subset_images, subset_true_labels, subset_predicted_labels, num_images=num_images_to_display)
